...
public class PlayerMoveResourceController extends AbstractResourceGameLogicController<AbstractPlayerMoveDto, AbstractPlayerMoveDto> {
    ...
    /**
     * @Override public ResponseEntity createAssociation(@PathVariable("uuid") String uuid,String  @RequestBody AbstractDto child, @RequestParam(value = "projection",required = false) QueryProjection projection) throws Exception {
