...
@Transactional
public interface PrejudiceTriggerRepository extends IPageableDao<BasePrejudiceTrigger>  , INamedObjectDao<StatPrejudiceTrigger>, IFindByIdentifier<StatPrejudiceTrigger> {
}
