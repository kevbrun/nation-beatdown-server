...
@Transactional
public interface CharacteristicPrejudiceTriggerRepository extends IPageableDao<CharacteristicPrejudiceTrigger> , INamedObjectDao<CharacteristicPrejudiceTrigger> {
}
