...
@Component
@FeignClient(contextId = "move-value-resource-service",value="nation-cloud-move-value-service",decode404 = true, configuration = FeignClientConfig.class)
public interface MoveValueServiceClient extends BaseServiceRestClientInterface<BasePlayerMoveValueDto,BasePlayerMoveValueDto> {
}
